(function() {
        ...
        SliderCaptcha.DEFAULTS = {
            ...
            localImages: function() {
                return '/img/captcha/' + Math.floor((Math.random() * 40) + 1) + '.jpg';
            },
        ...
        _proto.initImg = function() {
            ...
            img.setSrc = function() {
                ...
                if (!src || src === '')
                    src = '/img/captcha/' + Math.floor((Math.random() * 40) + 1) + '.jpg';
        ...
        _proto.bindEvents = function() {
            ...
            var handleDragMove = function(e) {
                ...
                if (!isMouseDown)
                    return false;
                var block_width = that.block.width;
                ...
                if (moveX < 0 || moveX + cur_block > that.options.width)
                    return false;
            ...
            // this.slider.addEventListener('click', handleDragEnd);
        ...
        _proto.reset = function() {
            ...
            this.slider.style.left = slider_left;
            this.block.style.left = slider_left;
